...
@Repository(value="reportSendTypeCombo")
public class ReportSendTypeComboboxDataProvider extends ComponentCreatorDataProvider<String>{
	/**
	 * 参数设置DAO
	 */
	@Resource
	...
	public List<Map<String,Object>> getDTOS() {
		List<ComboboxNodeDTO<String>>  comboboxNodeDTOList = 
				this.paramSettingDAO.getParamList(ComponentConst.SQL_GET_REPORT_SEND_TYPE_LIST, ComboboxNodeDTO.class);
