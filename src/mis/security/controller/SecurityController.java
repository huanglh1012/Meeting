...
public class SecurityController  {
	 ...
	 *     
	 */
	public AjaxResult modifyPassword(EmployeeDTO inEmployeeDTO) {
		ActionResult result = null;	
		AjaxResult ajaxResult = new AjaxResult();
		try {
			result = this.securityService.modifyPassword(inEmployeeDTO);
			ajaxResult.setSuccess(result.getIsSuccessful());
			ajaxResult.setMsg(result.getActionResultMessage());
		} catch (Exception e) {
			ajaxResult.setSuccess(false);
	 ...
	 *     用户列表
	 */
	public Object getEmployeeDetailInfoByEmployeeId(String inEmployeeId) {
		return this.securityService.getEmployeeDetailInfoByEmployeeId(inEmployeeId);
	}
