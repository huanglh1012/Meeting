...
public class SecurityConst {
	...
	public static final String SQL_GET_DEPARTMENT_EMPLOYEE_LIST = new StringBuilder(" SELECT DEPARTMENT_ID AS ID, DEPARTMENT_NAME AS NAME,ifnull(PARENT_DEPARTMENT_ID,'') AS P_ID,1 AS OPEN FROM DEPARTMENT ")
	.append(" union all ")
	.append(" SELECT EMPLOYEE_ID AS ID, EMPLOYEE_NAME AS NAME,DEPARTMENT_ID AS P_ID,1 AS OPEN FROM EMPLOYEE ")
	.toString();
