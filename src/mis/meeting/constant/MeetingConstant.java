...
public class MeetingConstant {
	...
	public static final String SQL_GET_MEETING_BY_PAN_DATETIME_RANG = 
			"SELECT * FROM MEETING A WHERE A.MEETING_ROOM_ID = ? AND (A.MEETING_START_TIME > ? AND A.MEETING_START_TIME < ?) "
	...
	public static final String SQL_GET_MEETING_ROOM_BOOKING_LIST_BY_ROOM_ID = "SELECT A.MEETING_ROOM_ID, "
			    ...
			    + " FROM MEETING_ROOM A, MEETING B, MEETING_MEMBER_RF C, EMPLOYEE D, DEPARTMENT E, MEETING_MEMBER_ROLE F "
